...
const YuyiAutonomous = (function() {
  ...
  async function loadGoals() {
    try {
      const data = await api_get('/autonomous/goals');
  ...
  async function loadReflections() {
    try {
      const data = await api_get('/autonomous/reflections');
  ...
  async function loadProactive() {
    try {
      const data = await api_get('/autonomous/proactive');
  ...
  async function loadDream() {
    try {
      const data = await api_get('/autonomous/dream');
  ...
  async function loadGrowthPending() {
    try {
      const data = await api_get('/autonomous/growth-pending');
      const stats = data.stats || {};
